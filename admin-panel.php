...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center">Hospital Database Management System</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Hospital Database Management System </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #00972d, #00ddc7);
}
